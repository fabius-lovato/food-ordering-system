    ...
    public void receive(@Payload List<RestaurantApprovalRequestAvroModel> messages,
        ...
        messages.forEach(restaurantApprovalRequestAvroModel -> {
            try {
                ...
                if ((sqlException == null) || !PSQLState.UNIQUE_VIOLATION.getState().equals(sqlException.getSQLState())) {
                    throw new RestaurantApplicationServiceException(
                            "Throwing DataAccessException in" + " RestaurantApprovalRequestKafkaListener: " + e.getMessage(), e);
                }
